...
import kamaanaMP4 from "./assets/P2 Sony/sony with sound.mp4";
...
function App() {
  return (
    <>
      <TransparentNavbar />
      <Video videoStyle="ratio ratio-16x9" src={mainVideo} autoPlay />
      <p className="m-3 p-3 text-center">
        Pandemonium is a collective of innovative trailblazers, constantly
        pushing the boundaries of creativity and technology. Drawing strength
        from our rich heritage, we are dedicated to building a legacy for the
        future of Pandemonium. <br />
        Whether it&apos;s our clients, our fellow creators, or anyone who makes
        the delivery of world-class work possible, our mission and values are
        the guiding principles for who we are, how we perform, and the content
        we create.
      </p>
      <div
